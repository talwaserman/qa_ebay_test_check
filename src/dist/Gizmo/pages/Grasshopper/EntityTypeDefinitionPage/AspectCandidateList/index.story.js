...
(0, _react2.storiesOf)('Gizmo/pages/Grasshopper/EntityTypeDefinitionPage/AspectCandidateList', module).addParameters({
  viewport: {
  ...
  notes: 'AspectCandidateList - list of candidate aspects to be used for the gloabl list component'
});