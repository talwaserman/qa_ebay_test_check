...
(0, _react2.storiesOf)('Gizmo/pages/Duplicates/ProductIndiciationSelect/ProductIndicationSelect', module).addParameters({
  viewport: {
  ...
  notes: 'ProductIndiciationSelect - select dropdown values'
});