...
(0, _react2.storiesOf)('Gizmo/pages/ManageObservationConfigurationPage', module).addParameters({
  viewport: {
  ...
  notes: 'ManageObservationConfigurationPage - wrapping both tables configuration table and related reason for each'
});