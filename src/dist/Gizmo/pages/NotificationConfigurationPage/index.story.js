...
(0, _react2.storiesOf)('Gizmo/pages/NotificationConfigurationPage', module).addParameters({
  viewport: {
  ...
  notes: 'NotificationConfigurationPage - for creating and managing notification configurations'
});